...
// Movement config
#define OW_RUNNING_INDOORS          GEN_7  // In Gen4+, players are allowed to run indoors.
...
#define GEN_6_ORAS GEN_7 + 1

// PC settings
#define OW_PC_PRESS_B               GEN_7 // In Gen4, pressing B when holding a Pokémon is equivalent to placing it. In Gen3, it gives the "You're holding a Pokémon!" error.
...
#define OW_SUPER_LUCK               GEN_7 // In Gen8+, if a Pokémon with Super Luck is leading the party, the wild held item rate is increased to 60%/20%.
#define OW_INFILTRATOR              GEN_7 // In Gen8+, if a Pokémon with Infiltrator is leading the party, the wild encounter rate is halved.
#define OW_HARVEST                  GEN_7 // In Gen8+, if a Pokémon with Harvest is leading the party, there is a 50% chance to encounter a Grass-type Pokémon.
#define OW_LIGHTNING_ROD            GEN_7 // In Gen8+, if a Pokémon with Lightning Rod is leading the party, there is a 50% chance to encounter an Electric-type Pokémon.
#define OW_STORM_DRAIN              GEN_7 // In Gen8+, if a Pokémon with Storm Drain is leading the party, there is a 50% chance to encounter a Water-type Pokémon.
#define OW_FLASH_FIRE               GEN_7 // In Gen8+, if a Pokémon with Flash Fire is leading the party, there is a 50% chance to encounter a Fire-type Pokémon.

// These generational defines only make a distinction for OW_ALTERED_TIME_RATIO
#define GEN_8_PLA                       GEN_7 + 2

//Time
#define OW_TIMES_OF_DAY                 GEN_7     // Different generations have the times of day change at different times.
...
#define OW_ALTERED_TIME_RATIO           GEN_8     // In GEN_8_PLA, the time in game moves forward 60 seconds for every second in the RTC. In GEN_9, it is 20 seconds. This has no effect if OW_USE_FAKE_RTC is FALSE.
...
// Pokémon Center
#define OW_IGNORE_EGGS_ON_HEAL           GEN_7              // In Gen 4+, the nurse in the Pokémon Center does not heal Eggs on healing machine.
